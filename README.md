...
**Alertas no Telegram:** um nó CPU/Android sempre ligado (aba *Alerts* do Config dele) vigia toda a frota, placas incluídas, e avisa no Telegram quando um nó cai ou volta, uma pool cai e o fallback assume, a temperatura passa do limite, shares são rejeitados em sequência ou um nó fica online sem minerar. Detalhes em [criptohost_cpuminer](https://github.com/criptohost/criptohost_cpuminer).
